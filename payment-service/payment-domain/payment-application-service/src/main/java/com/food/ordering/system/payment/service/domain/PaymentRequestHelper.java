...
public class PaymentRequestHelper {
    ...
    private void persistDbObjects(Payment payment, List<String> failureMessages, CreditEntry creditEntry,
    ...
    private boolean isOutboxMessageProcessed(PaymentRequest paymentRequest, PaymentStatus paymentStatus) {
    ...
    private boolean persistIfSucceeded(PaymentRequest paymentRequest, List<String> failureMessages,
                                       CreditEntry creditEntry, Payment payment, List<CreditHistory> creditHistories,
                                       PaymentEvent paymentEvent) {
