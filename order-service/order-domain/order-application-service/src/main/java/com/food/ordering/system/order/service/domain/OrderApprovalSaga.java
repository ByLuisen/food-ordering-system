...
public class OrderApprovalSaga implements SagaStep<RestaurantApprovalResponse> {
    ...
    public void rollback(RestaurantApprovalResponse restaurantApprovalResponse) {
        ...
        if (orderApprovalOutboxMessageResponse.isEmpty()) {
            log.info("An outbox message with saga id: {} is already roll back!", restaurantApprovalResponse.getSagaId());
            return;
        }
    ...
    private OrderPaymentOutboxMessage getUpdatedPaymentOutboxMessage(UUID sagaId, OrderStatus orderStatus,
