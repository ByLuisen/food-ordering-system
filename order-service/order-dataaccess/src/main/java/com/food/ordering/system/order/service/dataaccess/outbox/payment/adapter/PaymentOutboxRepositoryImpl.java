...
public class PaymentOutboxRepositoryImpl implements PaymentOutboxRepository {
        ...
        return paymentOutboxDataAccessMapper
                .paymentOutboxEntityToOrderPaymentOutboxMessage(paymentOutboxJpaRepository
                        .save(paymentOutboxDataAccessMapper
                                .orderPaymentOutboxMessageToPaymentOutboxMessage(orderPaymentOutboxMessage)));
    }
    ...
    public Optional<List<OrderPaymentOutboxMessage>> findByTypeAndOutboxStatusAndSagaStatus(String type, OutboxStatus outboxStatus, SagaStatus... sagaStatuses) {
        return Optional.of(paymentOutboxJpaRepository.findByTypeAndOutboxStatusAndSagaStatusIn(type,
                ...
                .orElseThrow(() -> new PaymentOutboxNotFoundException("Payment outbox object could not be found " +
                        "for saga type " + type))
                .stream()
